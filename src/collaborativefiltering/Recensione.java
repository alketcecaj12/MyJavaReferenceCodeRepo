...
public class Recensione {
	...
	public static void pScore(String c, Map<String , List<Recensione>> map){
		 ...
		 List<Double> dis = new ArrayList<Double>();
		    ...
		    //trovo le distanze (in termini di coeff.di pearson) di un utente verso tutti gli altri
		    ...
		    for (int i = 0; i < dis.size(); i++) {
			  System.out.println( i+" coefficenti di Pearson di "+c+" verso" +
			  		" critico " +d[i]+ " con valore "+dis.get(i));
		    }
