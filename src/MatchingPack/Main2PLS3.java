...
public class Main2PLS3 {
     ...
     public static void main (String[] args)throws Exception{
		...
		for (int i = 0; i < l.size(); i++) {
			long li = l.get(i);
			double m2 = run(30,0,li);
		}
	}
	
	public static double run(int nevent, double ds, long dt) throws Exception {
		String file2 = "54_Utenti_30Eventi.txt";
		String file = "C:\\DATA\\settimana\\CoordPLS";
		String file3 = "C:\\DATA\\AllData";
		...
		if(objfile.exists()) {
			ObjectInputStream ois = new ObjectInputStream(new BufferedInputStream(new FileInputStream(objfile)));
        ...
        loadBadUsers(badusers,  30,"EventsPerUser40GiorniNight.csv");
		//3-per ogniuno faccio il matching
		for (String s: map.keySet()){
			System.out.println("inizia la fase di matching ");
			data.put(s, PLSMethods.matchPLS(file3, map.get(s),badusers,ds,dt));
		}
